    ...
    private fun setupUI() {
        ...
        binding.btnOffline.setOnClickListener {
            if (!isOfflineMode) {
                ...
                if (recognized.isNotEmpty() && recognized != getString(R.string.ocr_recognizing)) performTranslation(recognized)
            }
        }
        ...
        binding.btnSwitch.setOnClickListener {
            ...
            updateDirectionUI()
            val recognized = binding.tvOcrResult.text.toString()
            if (recognized.isNotEmpty() && recognized != getString(R.string.ocr_recognizing)) {
        ...
        binding.btnTranslate.setOnClickListener {
            ...
            if (text.isNotEmpty() && text != getString(R.string.ocr_recognizing)) {
