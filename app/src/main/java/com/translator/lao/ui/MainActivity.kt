...
class MainActivity : AppCompatActivity() {
    ...
    private var isTranslating = false // 防抖
    ...
    private val networkCallback = object : ConnectivityManager.NetworkCallback() {
        ...
        override fun onCapabilitiesChanged(network: Network, caps: NetworkCapabilities) {
            ...
            runOnUiThread { updateNetworkStatus(online) }
        }
    }
    ...
    private fun setupActionButtons() {
        ...
        binding.btnHistory.setOnClickListener { HistoryActivity.start(this) }
        binding.btnFavorites.setOnClickListener { FavoritesActivity.start(this) }
        binding.btnOcr.setOnClickListener { OcrTranslateActivity.start(this) }
        binding.btnDictionary.setOnClickListener { DictionarySearchActivity.start(this) }
